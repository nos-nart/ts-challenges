...
To solve `90-hard-optional-keys`, we need to construct a type transformation that satisfies all test cases.
...
Returns the union of keys that are optional in `T`.
