...
To solve `27862-medium-cartesianproduct`, we need to construct a type transformation that satisfies all test cases.
...
Distributes unions `T` and `U` to produce all pairs `[T, U]`.
