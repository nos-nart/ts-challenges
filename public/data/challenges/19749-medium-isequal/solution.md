...
To solve `19749-medium-isequal`, we need to construct a type transformation that satisfies all test cases.
...
Uses deferred generic function conditional comparison to test strict type equality.
