...
To solve `33345-extreme-dynamic-route`, we need to construct a type transformation that satisfies all test cases.
...
Extracts route params from file paths like `[id]`, `[...slug]`, `[[...slug]]`.
