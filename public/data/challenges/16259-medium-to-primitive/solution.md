...
To solve `16259-medium-to-primitive`, we need to construct a type transformation that satisfies all test cases.
...
Converts literal primitive types into broad primitive types.
