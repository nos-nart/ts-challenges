...
To solve `21220-medium-permutations-of-tuple`, we need to construct a type transformation that satisfies all test cases.
...
> = T extends [infer Head, ...infer Tail]
  ? PermutationsOfTuple<Tail, [...Prev, Head], Acc | [Head, ...Prev, ...Tail]>
  : Acc
```

3. **Step 3: How It Works**:
Generates all permutations of a tuple as a union.
