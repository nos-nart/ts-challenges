...
To solve `216-extreme-slice`, we need to construct a type transformation that satisfies all test cases.
...
Array slice utility supporting negative and positive indices.
