...
To solve `33763-hard-union-to-object-from-key`, we need to construct a type transformation that satisfies all test cases.
...
```ts
type UnionToObjectFromKey<T, K extends PropertyKey> = {
  [P in K]: T
}
```

3. **Step 3: How It Works**:
Groups union objects by key.
