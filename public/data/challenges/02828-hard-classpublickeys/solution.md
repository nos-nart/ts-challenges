...
To solve `2828-hard-classpublickeys`, we need to construct a type transformation that satisfies all test cases.
...
In TypeScript, `keyof T` on a class instance only yields public members.
