...
To solve `29650-medium-extracttoobject`, we need to construct a type transformation that satisfies all test cases.
...
Extracts nested object properties from `T[U]` directly into `T`.
