...
To solve `57-hard-get-required`, we need to construct a type transformation that satisfies all test cases.
...
Checks `{} extends Pick<T, K>`. Optional properties allow empty object matches, while required properties do not.
