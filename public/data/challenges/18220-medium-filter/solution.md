...
To solve `18220-medium-filter`, we need to construct a type transformation that satisfies all test cases.
...
Keeps elements from tuple `T` that extend predicate type `P`.
