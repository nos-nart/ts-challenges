...
To solve `30301-medium-isodd`, we need to construct a type transformation that satisfies all test cases.
...
Checks if the last digit of integer `T` is an odd digit.
