...
To solve `300-hard-string-to-number`, we need to construct a type transformation that satisfies all test cases.
...
Uses TypeScript 4.7+ constrained `infer N extends number` inside a template literal.
