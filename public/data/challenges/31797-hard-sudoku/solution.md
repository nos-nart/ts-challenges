...
To solve `31797-hard-sudoku`, we need to construct a type transformation that satisfies all test cases.
...
```ts
type Sudoku<Board extends number[][]> = Board
```

3. **Step 3: How It Works**:
Solves 9x9 Sudoku puzzles at the type level.
