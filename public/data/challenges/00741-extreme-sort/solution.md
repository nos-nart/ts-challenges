...
To solve `741-extreme-sort`, we need to construct a type transformation that satisfies all test cases.
...
```ts
type Sort<Arr extends number[], Desc extends boolean = false> = Arr
```
