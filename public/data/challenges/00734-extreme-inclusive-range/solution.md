...
To solve `734-extreme-inclusive-range`, we need to construct a type transformation that satisfies all test cases.
...
```ts
type InclusiveRange<Lower extends number, Higher extends number> = number[]
```

3. **Step 3: How It Works**:
Generates inclusive integer range array.
