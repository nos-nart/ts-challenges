...
To solve `553-hard-deep-object-to-unique`, we need to construct a type transformation that satisfies all test cases.
...
type DeepObjectToUniq<T extends object, Path extends any[] = [T]> = {
  [K in keyof T]: T[K] extends object
    ? DeepObjectToUniq<T[K], [...Path, K]>
    : T[K]
} & { readonly [PathSymbol]?: Path }
```

3. **Step 3: How It Works**:
Attaches unique path-branded symbol types to deeply nested objects.
