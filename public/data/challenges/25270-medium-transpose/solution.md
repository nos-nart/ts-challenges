...
To solve `25270-medium-transpose`, we need to construct a type transformation that satisfies all test cases.
...
Transposes a 2D matrix tuple, mapping rows to columns.
