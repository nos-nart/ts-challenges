...
To solve `7258-hard-object-key-paths`, we need to construct a type transformation that satisfies all test cases.
...
Generates all nested dot-separated key paths in object `T`.
