...
To solve `34286-hard-take-elements`, we need to construct a type transformation that satisfies all test cases.
...
```ts
type Take<N extends number, Arr extends any[], Acc extends any[] = []> = Acc['length'] extends N
  ? Acc
  : Arr extends [infer Head, ...infer Tail]
    ? Take<N, Tail, [...Acc, Head]>
    : Acc
```
