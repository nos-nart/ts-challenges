...
To solve `34857-medium-defined-partial-record`, we need to construct a type transformation that satisfies all test cases.
...
```ts
type DefinedPartialRecord<T> = {
  [K in keyof T]?: T[K] extends undefined ? never : T[K]
}
```

3. **Step 3: How It Works**:
Types record where specified keys may be undefined or omitted.
