...
To solve `6228-extreme-json-parser`, we need to construct a type transformation that satisfies all test cases.
...
```ts
type Parse<T extends string> = any
```

3. **Step 3: How It Works**:
JSON string parser in TypeScript types.
